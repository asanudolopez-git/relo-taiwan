...
class Houses_Property_Meta_Boxes {
    ...
    public function ajax_get_stations_by_line() {
        ...
        foreach ($options as $value => $label) {
            if (empty($value)) continue; // Skip empty option
            $response[] = array(
                'id' => $value,
                'text' => $label
            );
        ...
        switch ($field['type']) {
            ...
            case 'gallery':
                ...
                <div class="gallery-images" data-field-name="<?php echo esc_attr($field['id']); ?>[]">
                    <p class="description"><?php _e('Drag and drop images to reorder. The first image will be used as the main property image.', 'houses-theme'); ?></p>
                    ...
                    <?php if (!empty($value)) : ?>
                        <?php foreach ($value as $image_id) : ?>
                            <div class="gallery-image" data-id="<?php echo esc_attr($image_id); ?>">
                                ...
                                <a href="#" class="remove-gallery-image dashicons dashicons-trash" title="<?php _e('Remove image', 'houses-theme'); ?>"></a>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
